...
{
	/// <summary>
	/// Provides raw sql queries for getting database metadata from MySql database.
	/// </summary>
	public class MySqlSqlProvider : EwgSqlProvider
	{
		#region Constructors
		/// <summary>
		/// Creates instance of entity works generator my sql sql provider object.
		/// </summary>
		public MySqlSqlProvider() : base()
		{
