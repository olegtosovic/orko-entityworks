...
{
	/// <summary>
	/// Provides raw sql queries for getting database metadata from oracle database.
	/// </summary>
	public class OracleSqlProvider : EwgSqlProvider
	{
		#region Constructors
		/// <summary>
		/// Creates instance of entity works generator oracle sql provider object.
		/// </summary>
		public OracleSqlProvider() : base()
		{
